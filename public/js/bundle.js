...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmVucmVqIiwiYSI6ImNrN240NnEyczA2dzIzZnBoOGc1cjgzcTEifQ.d5dImhLbe15PaKcpoh04Fw';
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'succes') {
              (0, _alerts.showAlert)('success', 'REVIEW UPDATED succesfully!');
              window.setTimeout(function () {
                location.reload();
              }, 1000);
            }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_E7aeihBMzOzRYFGGutYYbwDe00yYfiehcf'); // 1) Get checkout session from API
...
exports.setRating = exports.rating = void 0;

/* eslint-disable */
var rating = function rating() {
  console.log('in rating');
  document.addEventListener('DOMContentLoaded', function () {
    var stars = document.querySelectorAll('.fa-star-o'); // console.log('stars: ', stars);

    stars.forEach(function (star) {
      star.addEventListener('click', setRating);
    }); // console.log(stars);

    var rating = parseInt(document.querySelector('.ratings').getAttribute('data-rating'));
...
},{}],"postReview.js":[function(require,module,exports) {
"use strict";
...
var postReview = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'succes') {
              (0, _alerts.showAlert)('success', 'REVIEW CREATED succesfully!');
              window.setTimeout(function () {
  ...
  return function postReview(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.postReview = postReview;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"postTour.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.postTour = void 0;
...
var postTour = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'succes') {
              (0, _alerts.showAlert)('success', 'Tour CREATED succesfully!');
              window.setTimeout(function () {
...
var deleteTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id, name) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', "".concat(name, " Tour DELETED succesfully!"));
              window.setTimeout(function () {
                location.reload();
              }, 1000);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', 'USER DELETED succesfully!');
              window.setTimeout(function () {
                location.reload();
              }, 1000);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', "REVIEWS on ".concat(name, " DELETED succesfully!"));
              window.setTimeout(function () {
                location.reload();
              }, 1000);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteTourReviews.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteTourReviews = void 0;
...
var deleteTourReviews = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id) {
    var res, datas, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, data;
    ...
    }, _callee, null, [[0, 37], [11, 23, 27, 35], [28,, 30, 34]]);
  }));

  return function deleteTourReviews(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.deleteTourReviews = deleteTourReviews;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteTourBookings.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteTourBookings = void 0;
...
var deleteTourBookings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id, name) {
    var res, datas, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:3000/api/v1/bookings?tour=".concat(id)
            });
    ...
    }, _callee, null, [[1, 37], [12, 23, 27, 35], [28,, 30, 34]]);
  }));

  return function deleteTourBookings(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.deleteTourBookings = deleteTourBookings;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteUserBookings.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteUserBookings = void 0;
...
var deleteUserBookings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id, name) {
    var res, datas, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:3000/api/v1/bookings?user=".concat(id)
            });
    ...
    }, _callee, null, [[0, 35], [10, 21, 25, 33], [26,, 28, 32]]);
  }));

  return function deleteUserBookings(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.deleteUserBookings = deleteUserBookings;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"confirmBoxAlerts.js":[function(require,module,exports) {
"use strict";
...
var Confirm = {
  open: function open(options) {
    ...
    var confirmEl = template.content.querySelector('.confirm');
    var btnClose = template.content.querySelector('.confirm__close');
    var btnOk = template.content.querySelector('.confirm__button--ok');
    var btnCancel = template.content.querySelector('.confirm__button--cancel');
  ...
  _close: function _close(confirmEl) {
...
},{}],"selectedBox.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.selectedBox = void 0;

/* eslint-disable */
var selectedBox = function selectedBox() {
  ...
  selectedAll.forEach(function (selected) {
    ...
    var searchDifficulty = document.querySelector('.search--difficulty');
    ...
    document.addEventListener('click', function (e) {
      var targetElement = e.target; // console.log(targetElement);

      if (targetElement !== optionsContainer && // targetElement != searchBox &&
      targetElement !== optionsList && targetElement !== selected && targetElement !== search && targetElement !== searchDifficulty && optionsContainer.classList.contains('active')) {
        optionsContainer.classList.remove('active');
      }
    });
...
},{}],"rangeSliders.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.rangeSliders = void 0;

/* eslint-disable */
var rangeSliders = function rangeSliders() {
  var inputLeft = document.getElementById('input-left');
  var inputRight = document.getElementById('input-right');
  var thumbLeft = document.querySelector('.slider > .thumb.left');
  var thumbRight = document.querySelector('.slider > .thumb.right');
  var range = document.querySelector('.slider > .range');
  var selectedPrice = document.querySelector('.price'); // const placeholder = document.querySelector('.range__price');

  var priceRange = document.querySelector('.price__range');
  var optionPrice = document.querySelector('.option--price__range');
  var optionsContainer = document.querySelector('.options-container--range');

  var setSelectedPrice = function setSelectedPrice() {
    selectedPrice.textContent = "From ".concat(inputLeft.value, " to ").concat(inputRight.value);
  };

  var setMinMaxRange = function setMinMaxRange() {
    priceRange.innerHTML = "From $".concat(inputLeft.value, " to $").concat(inputRight.value);
  };

  setMinMaxRange();

  var setLeftValue = function setLeftValue() {
    var _this = inputLeft,
  ...
  var setRightValue = function setRightValue() {
  ...
  setRightValue();
  selectedPrice.addEventListener('click', function (e) {
    if (optionsContainer.classList.contains('active')) {
      optionsContainer.classList.remove('active');
    } else {
      var currentActive = document.querySelector('.options-container.active');
  ...
  document.addEventListener('click', function (e) {
    ...
    var testdate = new Date('07/20/2020').toISOString();
    console.log(testdate);

    if (targetElement != optionsContainer && targetElement != optionPrice && targetElement != selectedPrice && targetElement != inputLeft && targetElement != inputRight && optionsContainer.classList.contains('active')) {
      optionsContainer.classList.remove('active');
    }
  });
...
exports.rangeSliders = rangeSliders;
},{}],"deleteTag.js":[function(require,module,exports) {
"use strict";
...
var deleteTag = function deleteTag() {
  var deleteButton = document.querySelectorAll('.icon--close'); //   console.log('deletebutton', deleteButton);

  deleteButton.forEach(function (el) {
    el.addEventListener('click', function (e) {
      //   console.log('element button', el)
      var target = e.currentTarget.parentElement;
      var tags = target.parentElement.parentElement.querySelector('.tags');
      var label = tags.parentElement.parentElement.querySelector('.file__upload--label');
      var defaultLabelText = 'Nothing selected.'; //   const hiddenInput = tags.parentElement.parentElement.querySelector(
      //     '.file__upload--input'
      //   );
      //   console.log(hiddenInput);

      var tagArrLength = Array.from(tags.querySelectorAll('.tag--description')).length; // console.log(target);

      target.parentElement.removeChild(target); //   console.log(tagArrLength);
      // console.log(hiddenInput.value);

      if (tagArrLength <= 1) {
        label.textContent = defaultLabelText; // console.log(hiddenInput);
        // hiddenInput.value = '';
...
},{}],"initialFieldState.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initialFieldState = void 0;

/* eslint-disable */
// Type is either file / data /select
var initialFieldState = function initialFieldState(type, parent) {
  if (type === 'file') {
    var files = parent.querySelectorAll('.file'); // console.log('file', files);

    files.forEach(function (el) {
      return el.value = '';
    });
  } else if (type === 'data') {
    var datas = parent.querySelectorAll('.data'); // console.log('data', datas);

    datas.forEach(function (el) {
      return el.value = '';
    });
  } else if (type === 'select') {
    var selects = parent.querySelectorAll('.select'); // console.log('select', selects);
...
},{}],"inputAddFiles.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.inputAddFiles = void 0;

var _deleteTag = require("./deleteTag");

var _initialFieldState = require("./initialFieldState");

/* eslint-disable */
var inputAddFiles = function inputAddFiles() {
  Array.prototype.forEach.call(document.querySelectorAll('.btn--add-file'), function (button) {
    var hiddenInput = button.parentElement.querySelector('.file__upload--input');
    var label = button.parentElement.parentElement.querySelector('.file__upload--label');
    var defaultLabelText = 'Nothing selected.'; //set default label text if no tags

    if (button.parentElement.parentElement.querySelectorAll('.tag').length < 1) {
    ...
    hiddenInput.addEventListener('change', function () {
      var fileNameList = Array.from(hiddenInput.files).map(function (file) {
        return file.name;
      });

      var addTag = function addTag() {
        var parent = button.parentElement.parentElement.querySelector('.tags');
        var tagList = Array.from(parent.querySelectorAll('.tag--description')).map(function (el) {
          return el.textContent;
        }); //limit = tag number limit

        var appendTag = function appendTag(limit) {
          // console.log(tagList);
        ...
        label.textContent = ''; // fileNameList.forEach(el => {});
      };
      ...
      (0, _initialFieldState.initialFieldState)('file', parent);
      (0, _deleteTag.deleteTag)(); // const deleteButton = document.querySelectorAll('.icon--close');
...
exports.inputAddFiles = inputAddFiles;
},{"./deleteTag":"deleteTag.js","./initialFieldState":"initialFieldState.js"}],"inputAddData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.inputAddData = void 0;
...
/* eslint-disable */
var inputAddData = function inputAddData() {
  Array.prototype.forEach.call(document.querySelectorAll('.btn--add-data'), function (button) {
    var label = button.parentElement.querySelector('.file__upload--label');
    var defaultLabelText = 'Nothing selected.';
    ...
    button.addEventListener('click', function () {
      ...
      var location = {};
      location.longitude = button.parentElement.querySelector('.location-longitude').value;
      location.latitude = button.parentElement.querySelector('.location-latitude').value;
      location.address = button.parentElement.querySelector('.location-address').value;
      location.description = button.parentElement.querySelector('.location-description').value;
      location.day = button.parentElement.querySelector('.location-day').value;
      console.log(location.description); // Create tag

      var tag = document.createElement('div');
      tag.className = 'tag';
      tag.title = "\n      LOCATION OVERVIEW:\n      Location Longitude: ".concat(location.longitude, "\n      Location Latitude: ").concat(location.latitude, "\n      Location Address: ").concat(location.address, "\n      Location Description: ").concat(location.description, "\n      Location Day: ").concat(location.day, "\n      ");
      tag.innerHTML = "<div class=\"tag--description\" data-longitude=".concat(location.longitude, " data-latitude=").concat(location.latitude, " data-address=\"").concat(location.address, "\" data-description=\"").concat(location.description, "\" data-day=").concat(location.day, "> Tour Day ").concat(location.day, "</div>\n        <svg class=\"icon--close\">\n          <use xlink:href=\"/img/icons.svg#icon-x-circle\"></use></svg>"); //   tag.innerHTML = `
      //             <div class="tag">
      ...
      var emptyFields = Object.values(location).every(function (value) {
        return value === '';
      });
      var emptyCoordinates = [location.longitude, location.latitude].every(function (value) {
        return value === '';
      });
      var checkCoordinates = [location.longitude, location.latitude].includes(''); // console.log(emptyCoordinates, checkCoordinates);
      ...
      if (!emptyFields) {
        if (location.day !== '') {
          if (emptyCoordinates && checkCoordinates || !emptyCoordinates && !checkCoordinates) {
            var tags = button.parentElement.querySelector('.tags');
            tags.appendChild(tag);
            label.textContent = '';
          } else {
            console.log('error: If you want to put some coordinates, please put both longitude and latitude');
          }
        } else {
          console.log('error: You must define a tour day for this location!');
        }
      } else {
        console.log('error: You cannot add a location without information on it!');
      }

      console.log(tag);
      var parent = button.parentElement;
      (0, _initialFieldState.initialFieldState)('data', parent);
      (0, _deleteTag.deleteTag)(); // const deleteButton = document.querySelectorAll('.icon--close');
...
exports.inputAddData = inputAddData;
},{"./deleteTag":"deleteTag.js","./initialFieldState":"initialFieldState.js"}],"inputSelect.js":[function(require,module,exports) {
"use strict";
...
var inputSelect = function inputSelect() {
  Array.prototype.forEach.call(document.querySelectorAll('.btn--add-select'), function (button) {
    var hiddenSelect = button.parentElement.querySelector('.form__select');
    var label = button.parentElement.querySelector('.file__upload--label');
    console.log(label);
    var defaultLabelText = 'Nothing selected.';
    ...
    var tagParent = button.parentElement.querySelector('.tags');
    var id;
    var tagListDescriptions = [];
    var tagList = [];
    hiddenSelect.addEventListener('change', function (e) {
      ...
      tagListDescriptions = tagList.map(function (el) {
        return el.textContent;
      });
    ...
    button.addEventListener('click', function (e) {
      ...
      var tag = document.createElement('div');
      tag.className = 'tag';
      tag.title = "\n          Tour Guide: ".concat(hiddenSelect.value, "\n          Tour GuideId:").concat(id, "\n          ");
      tag.innerHTML = "\n                        <div class=\"tag--description\" data-id=".concat(id, ">").concat(hiddenSelect.value, "</div>\n                        <svg class=\"icon--close\">\n                          <use xlink:href=\"/img/icons.svg#icon-x-circle\"></use></svg>");
      tagList = Array.from(tagParent.querySelectorAll('.tag--description'));
      tagListDescriptions = tagList.map(function (el) {
        return el.textContent;
      ...
      if (!tagListDescriptions.includes(hiddenSelect.value) && hiddenSelect.value !== '') {
      ...
      var parent = button.parentElement;
      (0, _initialFieldState.initialFieldState)('select', parent);
      (0, _deleteTag.deleteTag)();
    });
  });
...
},{"./deleteTag":"deleteTag.js","./initialFieldState":"initialFieldState.js"}],"deleteUserReviews.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteUserReviews = void 0;
...
var deleteUserReviews = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id, name) {
    var res, datas, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:3000/api/v1/reviews?user=".concat(id)
            });
    ...
    }, _callee, null, [[1, 37], [11, 23, 27, 35], [28,, 30, 34]]);
  }));

  return function deleteUserReviews(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.deleteUserReviews = deleteUserReviews;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"fillUserProfil.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.fillUserProfil = void 0;
...
var fillUserProfil = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id) {
    var res, user, userRoleOptions;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 7:
            ...
            userRoleOptions = document.querySelector('.user-role').querySelectorAll('option');
            userRoleOptions.forEach(function (el) {
              if (el.value === user.role) el.setAttribute('selected', 'selected');
            });
            document.getElementById('name').value = user.name;
            document.getElementById('email').value = user.email; // const userStatusOptions = document
  ...
  return function fillUserProfil(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.fillUserProfil = fillUserProfil;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"fillTourForm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.fillTourForm = void 0;
...
var fillTourForm = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id) {
    var res, tour, difficulties, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, difficulty, imageCover, parentImageCover, tagImageCover, images, parentImages, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, image, tagImages, date, year, month, dt, description, locations, parentLocations, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, location, tagLocation, guides, guidesParent, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, guide, tagGuide;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            difficulties = document.querySelector('.difficulty').querySelectorAll('option'); // console.log(difficulties);
            // for.. of for async
            ...
            for (_iterator = difficulties[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              difficulty = _step.value;
          ...
          case 30:
            ...
            document.getElementById('description').value = tour.description; // console.log(imageCover);
            //Add imageCover tag

            imageCover = tour.imageCover;
            parentImageCover = document.querySelector('.tags--image-cover');
            tagImageCover = document.createElement('div');
            tagImageCover.className = 'tag';
            tagImageCover.title = tour.imageCover;
            tagImageCover.innerHTML = "\n                    <div class=\"tag--description\">".concat(imageCover, "</div>\n                    <svg class=\"icon--close\">\n                      <use xlink:href=\"/img/icons.svg#icon-x-circle\"></use></svg>");
            parentImageCover.appendChild(tagImageCover); //Add image tag

            images = tour.images; // console.log(images);

            parentImages = document.querySelector('.tags--image');
            _iteratorNormalCompletion2 = true;
            _didIteratorError2 = false;
            _iteratorError2 = undefined;
            _context.prev = 45;

            for (_iterator2 = images[Symbol.iterator](); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              image = _step2.value;
              tagImages = document.createElement('div');
              tagImages.className = 'tag';
              tagImages.title = image;
              tagImages.innerHTML = "\n                    <div class=\"tag--description\">".concat(image, "</div>\n                    <svg class=\"icon--close\">\n                      <use xlink:href=\"/img/icons.svg#icon-x-circle\"></use></svg>");
          ...
          case 61:
            date = new Date(tour.startDates[0]);
            ...
            document.getElementById('start-date').value = "".concat(month, "/").concat(dt, "/").concat(year);
            document.getElementById('start-location-longitude').value = tour.startLocation.coordinates[0];
            document.getElementById('start-location-latitude').value = tour.startLocation.coordinates[1];
            document.getElementById('start-location-address').value = tour.startLocation.address;
            description = tour.startLocation.description.split(', ');
            document.getElementById('start-location-town').value = description[0];
            document.getElementById('start-location-country').value = description[1]; //Add location Tag

            locations = tour.locations;
            parentLocations = document.querySelector('.tags--location'); // console.log(locations);
            ...
            for (_iterator3 = locations[Symbol.iterator](); !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              location = _step3.value;
              console.log(location);
              tagLocation = document.createElement('div');
              tagLocation.className = 'tag';
              tagLocation.title = "\n        LOCATION OVERVIEW:\n        Location Longitude: ".concat(location.coordinates[0], "\n        Location Latitude: ").concat(location.coordinates[1], "\n        Location Description: ").concat(location.description, "\n        Location Day: ").concat(location.day, "\n        ");
              tagLocation.innerHTML = "\n                        <div class=\"tag--description\" data-longitude=".concat(location.coordinates[0], " data-latitude=").concat(location.coordinates[1], " data-description=").concat(location.description, " data-day=").concat(location.day, "> Tour Day ").concat(location.day, "</div>\n                        <svg class=\"icon--close\">\n                          <use xlink:href=\"/img/icons.svg#icon-x-circle\"></use></svg>");
          ...
          case 95:
            guides = tour.guides;
            guidesParent = document.querySelector('.tags--guide'); // console.log(guidesParent);
            ...
            for (_iterator4 = guides[Symbol.iterator](); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
              guide = _step4.value;
              //   console.log(guide);
              tagGuide = document.createElement('div');
              tagGuide.className = 'tag';
              tagGuide.title = "\n                Tour Guide: ".concat(guide.name, "\n                Tour GuideId:").concat(guide._id, "\n                ");
              tagGuide.innerHTML = "\n                              <div class=\"tag--description\" data-id=".concat(guide._id, ">").concat(guide.name, "</div>\n                              <svg class=\"icon--close\">\n                                <use xlink:href=\"/img/icons.svg#icon-x-circle\"></use></svg>");
          ...
          case 118:
            ...
            (0, _alerts.showAlert)('error', _context.t4.response.data.message);
    ...
    }, _callee, null, [[0, 118], [14, 18, 22, 30], [23,, 25, 29], [45, 49, 53, 61], [54,, 56, 60], [79, 83, 87, 95], [88,, 90, 94], [100, 104, 108, 116], [109,, 111, 115]]);
  }));

  return function fillTourForm(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.fillTourForm = fillTourForm;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'succes') {
              (0, _alerts.showAlert)('success', "".concat(data.name, " Profil UPDATED succesfully!"));
              window.setTimeout(function () {
                location.reload();
              }, 1000);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'succes') {
              (0, _alerts.showAlert)('success', "".concat(data.name, "  UPDATED succesfully!"));
              window.setTimeout(function () {
                location.reload();
              }, 1000);
            }
...
var _postReview = require("./postReview");

var _postTour = require("./postTour");
...
var _deleteTourReviews = require("./deleteTourReviews");

var _deleteTourBookings = require("./deleteTourBookings");

var _deleteUserBookings = require("./deleteUserBookings");

var _confirmBoxAlerts = require("./confirmBoxAlerts");

var _selectedBox = require("./selectedBox");

var _rangeSliders = require("./rangeSliders");

var _inputAddFiles = require("./inputAddFiles");

var _inputAddData = require("./inputAddData");

var _inputSelect = require("./inputSelect");

var _deleteTag = require("./deleteTag");

var _deleteUserReviews = require("./deleteUserReviews");

var _fillUserProfil = require("./fillUserProfil");

var _fillTourForm = require("./fillTourForm");
...
var userReviewForm = document.querySelector('.form__edit-review');
var editUser = document.querySelector('.edit-user');
var adminUpdateTour = document.querySelector('.edit-tour');
var userPasswordForm = document.querySelector('.form-user-password');
var createTour = document.querySelector('.create-tour');
var adminDeleteTour = document.querySelectorAll('.delete-tour');
var adminDeleteUser = document.querySelectorAll('.delete-user');
var bookBtn = document.getElementById('book-tour');
var editRating = document.querySelector('.ratings');
var userPostReviewForm = document.querySelector('.form__create-review');
var userDeleteReview = document.querySelectorAll('.delete-review');
var destinationOption = document.querySelector('.filter');
var dateOption = document.querySelector('.datepicker'); // const priceOption = document.querySelector('p');
// const rangeSlider = document.getElementById('sliders');

var test = document.querySelector('.test'); // const search = document.querySelector('.filter__search ');

var btnSearchTour = document.getElementById('btn__search--tour');
var selectedDestination = document.getElementById('selected--destination');
var selectedDates = document.querySelector('.datepicker');
var selectedDifficulty = document.getElementById('selected--difficulty');
var today = new Date(); //padstart: complete string ex '5' -> padstart(2,0) -> '05'

var dd = String(today.getDate()).padStart(2, '0');
var mm = String(today.getMonth() + 1).padStart(2, '0'); //January is 0!

var yyyy = today.getFullYear(); // DELEGATION
...
if (userReviewForm) {
  userReviewForm.addEventListener('submit', function (e) {
    ...
    var id = document.querySelector('.ratings').dataset.id;
    console.log(id);
    (0, _updateReview.updateReview)(data, id);
  });
}

if (userPostReviewForm) {
  userPostReviewForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var data = {};
    data.review = document.getElementById('review').value;
    data.rating = parseInt(document.querySelector('.ratings').dataset.rating);
    var id = document.querySelector('.form__create-review').dataset.id;
    (0, _postReview.postReview)(data, id);
  });
}

if (userDeleteReview) {
  console.log(userDeleteReview);
  userDeleteReview.forEach(function (element) {
    element.addEventListener('click', function (e) {
      e.preventDefault();
      var _e$currentTarget$data = e.currentTarget.dataset,
          id = _e$currentTarget$data.id,
          tourname = _e$currentTarget$data.tourname;

      _confirmBoxAlerts.Confirm.open({
        title: 'Delete Review',
        message: "Are you sure you want to delete your review on ".concat(tourname, " tour?"),
        onok: function onok() {
          (0, _deleteReview.deleteReview)(id, tourname);
        }
      }); // console.log(id);
      // deleteReview(id);
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              document.querySelector('.btn--save-password').textContent = 'Save password'; // document.querySelector('.btn--save-password').classList.remove('.btn--save-password')
...
if (test) {
  (0, _rangeSliders.rangeSliders)();
}

if (btnSearchTour) {
  btnSearchTour.onclick = function () {
    var destination;
    var startDate;
    var difficulty;
    ...
    if (selectedDates.value === '') {
      startDate = new Date("".concat(mm, "/").concat(dd, "/").concat(yyyy)).toISOString();
    } else {
    ...
    var priceMin = document.getElementById('input-left').value;
    var priceMax = document.getElementById('input-right').value;
    btnSearchTour.setAttribute('href', "/tours/".concat(destination, "/").concat(startDate, "/").concat(difficulty, "/").concat(priceMin, "-").concat(priceMax));
  };
}
...
if (createTour) {
  ...
  (0, _deleteTag.deleteTag)();
  (0, _inputAddFiles.inputAddFiles)();
  (0, _inputAddData.inputAddData)();
  ...
  document.getElementById('start-date').value = "".concat(mm, "/").concat(dd, "/").concat(yyyy);
  var submitBtn = document.querySelector('.btn--submit');
  submitBtn.addEventListener('click', function () {
    var name = document.getElementById('name').value;
    var duration = document.getElementById('duration').value;
    var maxGroupSize = document.getElementById('max-group-size').value;
    var difficulty = document.getElementById('difficulty').value;
    var price = document.getElementById('price').value;
    var summary = document.getElementById('summary').value;
    var description = document.getElementById('description').value;
    var imageCover = document.querySelector('.tags--image-cover').querySelector('.tag--description').textContent;
    var images = Array.prototype.map.call(document.querySelector('.tags--image').querySelectorAll('.tag--description'), function (e) {
    ...
    if (document.getElementById('start-date').value === '') {
      startDates.push(new Date("".concat(mm, "/").concat(dd, "/").concat(yyyy)).toISOString());
    } else {
      startDates.push(new Date(document.getElementById('start-date').value).toISOString());
    }

    var startLocation = {};
    startLocation.coordinates = [document.getElementById('start-location-longitude').value, document.getElementById('start-location-latitude').value];
    startLocation.address = document.getElementById('start-location-address').value;
    startLocation.description = "".concat(document.getElementById('start-location-town').value, ", ").concat(document.getElementById('start-location-country').value);
    var locations = [];
    var locationList = document.querySelector('.tags--location').querySelectorAll('.tag--description');
    locationList.forEach(function (el) {
      var location = {};
      console.log('el dataset', el.dataset);
      var _el$dataset = el.dataset,
          longitude = _el$dataset.longitude,
          latitude = _el$dataset.latitude,
          address = _el$dataset.address,
          description = _el$dataset.description,
          day = _el$dataset.day;
      location.coordinates = [longitude, latitude];
      location.address = address;
      location.description = description;
      location.day = day;
      console.log(location); // location.coordinates = [el.dataset.longitude, el.dataset.latitude];
    ...
    var guides = [];
    var guidesList = document.querySelector('.tags--guide').querySelectorAll('.tag--description'); // console.log('guidelist', guidesList);

    guidesList.forEach(function (el) {
    ...
    console.log(data);
    (0, _postTour.postTour)(data);
  });
}

if (adminDeleteTour) {
  adminDeleteTour.forEach(function (element) {
    element.addEventListener('click', function (e) {
      e.preventDefault();
      var _e$currentTarget$data2 = e.currentTarget.dataset,
          id = _e$currentTarget$data2.id,
          tourname = _e$currentTarget$data2.tourname;
      console.log(tourname);

      _confirmBoxAlerts.Confirm.open({
        title: 'Delete Tour',
        message: "Are you sure you want to delete ".concat(tourname, " ?"),
        onok: function onok() {
          var deletingTour = /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      _context2.next = 2;
                      return (0, _deleteTourReviews.deleteTourReviews)(id);

                    case 2:
                      _context2.next = 4;
                      return (0, _deleteTourBookings.deleteTourBookings)(id);

                    case 4:
                      _context2.next = 6;
                      return (0, _deleteTour.deleteTour)(id);
...
if (adminUpdateTour) {
  ...
  var id = document.querySelector('.edit-tour').dataset.id;

  var updateTourForm = /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return (0, _fillTourForm.fillTourForm)(id);
            ...
            case 2:
              ...
              (0, _inputAddData.inputAddData)();
              (0, _inputSelect.inputSelect)();
              adminUpdateTour.addEventListener('click', function () {
                var data = {};
                ...
                images;
                data.imageCover = document.querySelector('.tags--image-cover').querySelector('.tag--description').textContent;
                console.log(data.imageCover);
                data.images = []; // console.log(images);

                var images = document.querySelector('.tags--image').querySelectorAll('.tag--description');
                ...
                var startDate = new Date(document.getElementById('start-date').value).toISOString();
                data.startDates = [startDate];
                data.startLocation = {};
                data.startLocation.coordinates = [document.getElementById('start-location-longitude').value, document.getElementById('start-location-latitude').value];
                data.startLocation.address = document.getElementById('start-location-address').value;
                var startLocationTown = document.getElementById('start-location-town').value;
                var startLocationCountry = document.getElementById('start-location-country').value;
                data.startLocation.description = "".concat(startLocationTown, ", ").concat(startLocationCountry);
                data.locations = [];
                var locations = document.querySelector('.tags--location').querySelectorAll('.tag--description');
                ...
                try {
                  for (var _iterator2 = locations[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    ...
                    // console.log('hey');
                    var loc = {};
                    var _location$dataset = location.dataset,
                        longitude = _location$dataset.longitude,
                        latitude = _location$dataset.latitude,
                        description = _location$dataset.description,
                        day = _location$dataset.day;
                    loc.coordinates = [longitude, latitude];
                    loc.description = description;
                    loc.day = day;
                    console.log(longitude, latitude, description, day); // console.log('hello', loc);
                ...
                data.guides = [];
                var guides = document.querySelector('.tags--guide').querySelectorAll('.tag--description');
                var _iteratorNormalCompletion3 = true;
                var _didIteratorError3 = false;
                var _iteratorError3 = undefined;

                try {
                  for (var _iterator3 = guides[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                ...
                console.log(data);
                (0, _updateTour.updateTour)(id, data);
              });
    ...
    return function updateTourForm() {
...
if (adminDeleteUser) {
  // console.log(userDeleteReview);
  adminDeleteUser.forEach(function (element) {
    element.addEventListener('click', function (e) {
      e.preventDefault();
      var _e$currentTarget$data3 = e.currentTarget.dataset,
          id = _e$currentTarget$data3.id,
          name = _e$currentTarget$data3.name;

      _confirmBoxAlerts.Confirm.open({
        title: 'Delete User',
        message: "Are you sure you want to delete ".concat(name, " profil?"),
        onok: function onok() {
          var deletingUser = /*#__PURE__*/function () {
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      console.log(name);
                      _context4.next = 3;
                      return (0, _deleteUserReviews.deleteUserReviews)(id, name);

                    case 3:
                      _context4.next = 5;
                      return (0, _deleteUserBookings.deleteUserBookings)(id, name);

                    case 5:
                      _context4.next = 7;
                      return (0, _deleteUser.deleteUser)(id, name);
...
if (editUser) {
  var userId = document.querySelector('.edit-user').dataset.id;

  var updateUserProfil = /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return (0, _fillUserProfil.fillUserProfil)(userId);
            ...
            case 2:
              editUser.addEventListener('click', function () {
                ...
                console.log(data);
                (0, _updateUser.updateUser)(data, userId);
              });
    ...
    return function updateUserProfil() {
